                ...
                <table class="table table-dark table-transparent table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            %>
                            <button href="<%=request.getContextPath()%>/FavoritaServlet?a=favorita&id=<%=banda.getIdlider() %>"
                                    type="button" class="btn btn-warning">favorito</button>
                            <% }
                            else{%>
                            <button href="<%=request.getContextPath()%>/FavoritaServlet?a=no_favorita&id=<%=banda.getIdlider() %>"
